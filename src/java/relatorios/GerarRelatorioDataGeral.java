 ...
 */
@ManagedBean(name = "gerarRelatorioDataGeral")
public class GerarRelatorioDataGeral {
    public static void gerarRelatorio(List<RelatorioCoordenacao> faltas) throws JRException, ParseException, IOException {

        JasperReport report = JasperCompileManager.compileReport("C:\\Users\\AlanaMaria\\Desktop\\CFREQ\\src\\java\\relatorios\\relatorioDataGeral.jrxml");
        ...
        httpServletResponse.addHeader("Content-disposition",
                "attachment; filename=relatorioDataGeral.pdf");
        ...
        JasperExportManager.exportReportToPdfFile(print,
                "Relatorio_Falta_Geral.pdf");

        FacesContext.getCurrentInstance().responseComplete();

    }

    public void preencherRelatorio(Date inicio, Date termino) throws JRException, ParseException, IOException {
